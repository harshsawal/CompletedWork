...
public class BillingTest {
	...
	/**
	 * Check that the history reports a mock history of three updates.
	 */
	@Test
	public void testGetHistory() {
		when(mockPersistence.getHistory()).thenReturn(createMockHistory());
		assertCorrectHistory(billing.getHistory(), 
