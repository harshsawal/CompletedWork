 ...
 * @author Will Provost
 */
public class ReportControllerWebClientTest extends WebClientTestBase {
	...
	public void testReportInvoicesOrderedByNumber() {
		assertCorrectOutput(getOne("/invoices", String.class),
	...
	public void testReportInvoicesGroupedByCustomer() {
		assertCorrectInvoicesByCustomer
			(getOne("/invoices_by_customer", String.class),
				Reporter.FILENAME_INVOICES_BY_CUSTOMER);
	}
	
	@Test
	public void testReportOverdueInvoices() {
		assertCorrectOutput(getOne("/overdue_invoices", String.class),
				Reporter.FILENAME_OVERDUE_INVOICES);
	}
	
	@Test
	public void testReportCustomersAndVolume() {
		assertCorrectOutput(getOne("/customers_and_volume", String.class),
